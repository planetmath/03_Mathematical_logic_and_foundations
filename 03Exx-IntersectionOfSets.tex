...
\usepackage{pmmeta}
\pmcanonicalname{IntersectionOfSets}
\pmcreated{2013-03-22 14:01:50}
\pmmodified{2013-03-22 14:01:50}
\pmowner{drini}{3}
\pmmodifier{drini}{3}
\pmtitle{intersection of sets}
\pmrecord{6}{35085}
\pmprivacy{1}
\pmauthor{drini}{3}
\pmtype{Definition}
...
%% \include{argawarga}
\begin{document}
Let $X,Y$ be sets. The intersection of $X$ and $Y$, denoted $X\cap Y$ is the set
