...
\usepackage{pmmeta}
\pmcanonicalname{Language}
\pmcreated{2013-03-22 12:17:10}
\pmmodified{2013-03-22 12:17:10}
\pmowner{mps}{409}
\pmmodifier{mps}{409}
\pmtitle{language}
\pmrecord{28}{31767}
...
\pmsynonym{$\lambda$-free}{Language}
\pmrelated{Alphabet}
...
\pmrelated{FirstOrderLanguage}
\pmrelated{TermsAndFormulas}
\pmrelated{Word}
\pmdefines{string}
\pmdefines{empty language}
\pmdefines{substring}
\pmdefines{proper language}
\pmdefines{improper language}
\pmdefines{alphabet of a language}
\pmdefines{alphabet of a word}
\pmdefines{finite language}
\pmdefines{atomic language}
