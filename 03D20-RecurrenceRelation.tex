...
\usepackage{pmmeta}
\pmcanonicalname{RecurrenceRelation}
\pmcreated{2013-03-22 11:56:04}
\pmmodified{2013-03-22 11:56:04}
\pmowner{rspuzio}{6075}
\pmmodifier{rspuzio}{6075}
\pmtitle{recurrence relation}
\pmrecord{13}{30664}
\pmprivacy{1}
...
\pmsynonym{difference equation}{RecurrenceRelation}
\pmrelated{BerlekampMasseyAlgorithm}
\pmrelated{Equation}
\pmrelated{FiniteDifference}
\pmdefines{first order}
\pmdefines{second order}
\pmdefines{kth order}
