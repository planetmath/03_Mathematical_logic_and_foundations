...
\usepackage{pmmeta}
\pmcanonicalname{310WhenArePropositionsTruncated}
\pmcreated{2013-11-17 20:20:34}
\pmmodified{2013-11-17 20:20:34}
\pmowner{PMBookProject}{1000683}
\pmmodifier{rspuzio}{6075}
\pmtitle{3.10 When are propositions truncated?}
\pmrecord{3}{87658}
\pmprivacy{1}
...
Admittedly, this is not an ideal example, since ``$p=2$'' and ``$p$ is odd'' are mutually exclusive, so that $(p=2)+(p\text{ is odd})$ is in fact already a mere proposition and hence equivalent to its truncation (see \PMlinkexternal{Exercise 3.7}{http://planetmath.org/node/87851}).
...
\item We want to emphasize that the notion of ``mere proposition'' is not a fundamental part of type theory.
  As we will see in \PMlinkexternal{Chapter 7}{http://planetmath.org/node/87580}, mere propositions are just the second rung on an infinite ladder, and there are also many other modalities not lying on this ladder at all.
...
\item On the other hand, one of the most interesting observations of homotopy type theory is that a surprising number of types are \emph{automatically} mere propositions, or can be slightly modified to become so, without the need for any truncation.
  (See \PMlinkname{Lemma 3.3.5}{33merepropositions#Thmprelem4},\PMlinkexternal{Chapter 4}{http://planetmath.org/node/87577},\PMlinkexternal{Chapter 7}{http://planetmath.org/node/87580},\PMlinkexternal{Chapter 9}{http://planetmath.org/node/87583},\PMlinkexternal{Chapter 10}{http://planetmath.org/node/87584}.)
