...
\usepackage{pmmeta}
\pmcanonicalname{CriterionForConsistencyOfSetsOfFormulas}
\pmcreated{2013-03-22 12:44:05}
\pmmodified{2013-03-22 12:44:05}
\pmowner{jihemme}{316}
\pmmodifier{jihemme}{316}
\pmtitle{criterion for consistency of sets of formulas}
\pmrecord{5}{33035}
\pmprivacy{1}
...
\end{array}\right)}
\begin{document}
Let $L$ be a first order language, and $\Delta\subseteq L$ be a set of sentences.  Then $\Delta$ is consistent if and only if every finite subset of $\Delta$ is consistent.
%%%%%
%%%%%
\end{document}
