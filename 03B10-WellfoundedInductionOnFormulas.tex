...
\usepackage{pmmeta}
\pmcanonicalname{WellfoundedInductionOnFormulas}
\pmcreated{2013-03-22 12:42:49}
\pmmodified{2013-03-22 12:42:49}
\pmowner{jihemme}{316}
\pmmodifier{jihemme}{316}
\pmtitle{well-founded induction on formulas}
\pmrecord{6}{33000}
\pmprivacy{1}
...
\begin{enumerate}
\item $P$ is true for the atomic formulas;
\item for every formula $\varphi$, if $P$ is true for every subformula of $\varphi$, then $P$ is true for $\varphi$.
\end{enumerate}
%%%%%
%%%%%
\end{document}
