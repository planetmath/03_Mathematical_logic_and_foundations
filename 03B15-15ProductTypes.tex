...
\usepackage{pmmeta}
\pmcanonicalname{15ProductTypes}
\pmcreated{2013-11-13 18:00:07}
\pmmodified{2013-11-13 18:00:07}
\pmowner{PMBookProject}{1000683}
\pmmodifier{rspuzio}{6075}
\pmtitle{1.5 Product types}
\pmrecord{19}{87541}
\pmprivacy{1}
...
\renewcommand{\theprermk}{1.5.\arabic{mathcount}}
\renewcommand{\theequation}{1.5.\arabic{mathcount}}
\begin{document}
...
For other types, the uniqueness principle says that every map (function) \emph{from} that type is uniquely determined by some data. (An example is the coproduct type introduced in \PMlinkname{\S 1.7}{17coproducttypes}, whose uniqueness principle is mentioned in \PMlinkname{\S 2.15}{215universalproperties}.)  
  ...
  \end{enumerate}
The inference rules in \PMlinkname{\S A.3}{a3homotopytypetheory} are organized and named accordingly; see, for example, \PMlinkname{\S A.2.4}{a24dependentfunctiontypespitypes}, where each possibility is realized.
\end{rmk}
...
Here we are using the identity type, which we are going to introduce below in \PMlinkname{\S 1.12}{112identitytypes}.
